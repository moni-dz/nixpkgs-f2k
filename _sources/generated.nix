...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  stevenblack-blocklist = {
    ...
    version = "86956052240f198dad3d3a9b74b9c3a4e0f71340";
    src = fetchFromGitHub {
      owner = "stevenblack";
      repo = "hosts";
      rev = "86956052240f198dad3d3a9b74b9c3a4e0f71340";
      fetchSubmodules = false;
      sha256 = "sha256-VtrnU7JLW6sri0FHgRVDUmtxwCplYN1aPmP6hgV+Hoc=";
    };
    date = "2023-08-05";
  };
  wezterm = {
    pname = "wezterm";
    version = "59b8664eb3ff01d0a29eecbabe72b34d944dc829";
    src = fetchgit {
      url = "https://github.com/wez/wezterm.git";
      rev = "59b8664eb3ff01d0a29eecbabe72b34d944dc829";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-fDMAImMN9yobpmDI2gLeCGiVCqFgXJFbNw9sDapMBLg=";
    };
    date = "2023-08-06";
  };
}
