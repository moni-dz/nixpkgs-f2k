...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  river = {
    pname = "river";
    version = "3fa44d85091c77b72138580e14023f03c6bddc17";
    src = fetchgit {
      url = "https://github.com/riverwm/river.git";
      rev = "3fa44d85091c77b72138580e14023f03c6bddc17";
      fetchSubmodules = true;
      deepClone = false;
      leaveDotGit = false;
      sha256 = "sha256-KfSRTHDsEpv6w0MM1Rpzpj7/60wwzDtbazrKNnjYIhE=";
    };
    date = "2023-10-21";
  };
  stevenblack-blocklist = {
    pname = "stevenblack-blocklist";
    version = "05cdb4d0a2161aed9e83307c3cfe5c145460862d";
    src = fetchFromGitHub {
      owner = "stevenblack";
      repo = "hosts";
      rev = "05cdb4d0a2161aed9e83307c3cfe5c145460862d";
      fetchSubmodules = false;
      sha256 = "sha256-0GcBuv9ecO3Q8/RqarWN4jK0HIbTjrSuuJ5ofi+7OXU=";
    };
    date = "2023-10-23";
  };
  wezterm = {
